...
<head>
    ...
    <link rel="stylesheet" href="stylesEB.css">
</head>
<header>
    <?php
    ...
    // Consulta para obtener los nombres de los autores
...
<body>
    <div class="container">
        <div class="left-column">
            <div class="form-container">
                <form id="bookForm" action="editBook.php" method="post">
                    <h2>Editar Libro</h2>
    ...
    function searchBooks() {
        ...
        if (selectedAuthor !== '') {
            fetch('buscarLibrosPorAutor.php?autor=' + encodeURIComponent(selectedAuthor))
