...
<body>
    ...
    <div class="left-column">
      <div class="form-container">
            <h2>Editar Autor</h2>
            <form id="authorForm" action="editAuthor.php" method="post">
...
<script>
    function searchAuthor() {
        ...
        if (selectedAuthor !== '') {
            fetch('buscarAutor.php?autor=' + encodeURIComponent(selectedAuthor))
...
table.addEventListener('click', function(event) {
  if (event.target.tagName === 'TR') {
    ...
    document.getElementById('id_autor').value = rowData[2].textContent;
